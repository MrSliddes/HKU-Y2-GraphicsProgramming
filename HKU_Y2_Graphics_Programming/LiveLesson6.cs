...
namespace HKU_Y2_Graphics_Programming
{
	...
	{		
		...
		private Texture2D heightmap, dirt, water, rock, grass, snow, plant, waterNormal;
		...
		Vector3 cameraPos = Vector3.One * 128f;
		...
		public override void Draw(GameTime gameTime, GraphicsDeviceManager graphics, SpriteBatch spriteBatch) {
			...
			device.RasterizerState = RasterizerState.CullNone;
			device.DepthStencilState = DepthStencilState.Default;
			RenderModel(sphere, World * Matrix.CreateTranslation(Vector3.Right * 512 - Vector3.Forward * 1000 + Vector3.Up * 300));
